...
public class SectorCreatePage {
    ...
    @FindBy(className = "new_sector")
    private WebElement newSectorBtn;

    @FindBy(id = "create_btn")
    private WebElement submitbtn;

    public SectorCreatePage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public WebElement getNewSectorBtn() {
        return newSectorBtn;
    }
